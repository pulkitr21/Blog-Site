...
* Harden MessageHandler in app.js to avoid issues where we cannot find a callback for an operation.
...
* Added socketTimeoutMS and connectTimeoutMS to socket options for repl_set.js and app.js
...
* Correctly emit errors from app.js only wrapping errors that are strings
