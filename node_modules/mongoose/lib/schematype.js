 ...
 *     });
 *
 *     var User = db.models('User', UserSchema);
 *
 ...
 *     })
 *
 *     var Virus = db.models('Virus', VirusSchema);
 ...
 *     });
 *
 *     var Account = db.models('Account', AccountSchema);
 *
 ...
 *
 *     var Product = conn.models('Product', yourSchema);
 *     var dvd = new Product(..);
 ...
 * ####Example:
 *
 *     T = db.models('T', new Schema({ x: { type: String, select: true }}));
...
SchemaType._isRef = function(self, value, doc, init) {
  ...
  if (!ref && doc && doc.$__fullPath) {
    // checks for
    // - this populated with adhoc models and no ref was set in schema OR
