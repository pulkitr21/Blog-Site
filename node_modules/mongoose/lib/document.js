...
function init(self, obj, doc, prefix) {
  ...
  function _init(index) {
    ...
    // Should still work if not a models-level discriminator, but should not be
    // necessary. This is *only* to catch the case where we queried using the
    // base models and the discriminated models has a projection
...
Document.prototype.$set = function $set(path, val, type, options) {
  ...
  try {
    ...
    // the correct models name, treat it as populated
 ...
 * ####Example
 *
 *     MyModel = mongoose.models('test', { name: { type: String, default: 'Val '} });
 *     var m = new MyModel();
