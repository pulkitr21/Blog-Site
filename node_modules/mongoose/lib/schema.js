 ...
 *     var Tree = mongoose.models('Tree', schema);
 *
 ...
 * an object with 2 properties: `schema` and `models`.
 *
 ...
 *     });
 *
 *     var Model = mongoose.models('Model', schema);
 *
 *     var m = new Model(..);
 *     m.save(function(err) {
 ...
 *     })
 *
 *     var Kitty = mongoose.models('Kitty', schema);
 *
 *     var fizz = new Kitty;
 ...
 *     });
 *
 *     var Drink = mongoose.models('Drink', schema);
